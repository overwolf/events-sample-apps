// this a subset of the features that Football Manager 2021 events provides - however,
...
function gameLaunched(gameInfoResult) {
  ...
  if (Math.floor(gameInfoResult.gameInfo.id/10) != 21666) {
    return false;
  }

  console.log("Football Manager 2021 Launched");
  return true;
...
function gameRunning(gameInfo) {
  ...
  // NOTE: we divide by 10 to get the game class id without it's sequence number
  if (Math.floor(gameInfo.id/10) != 21666) {
    return false;
  }

  console.log("Football Manager 2021 running");
  return true;
