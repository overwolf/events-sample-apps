// this a subset of the features that Call of Duty: vanguard events provides - however,
...
function gameLaunched(gameInfoResult) {
  ...
  if (Math.floor(gameInfoResult.gameInfo.id/10) != 21876) {
    return false;
  }

  console.log("Call of Duty: Vanguard Launched");
  return true;
...
function gameRunning(gameInfo) {
  ...
  // NOTE: we divide by 10 to get the game class id without it's sequence number
  if (Math.floor(gameInfo.id/10) != 21876) {
    return false;
  }

  console.log("Call of Duty: Vanguard running");
  return true;
