// this a subset of the features that Football Manager 2022 events provides - however,
...
function gameLaunched(gameInfoResult) {
  ...
  if (Math.floor(gameInfoResult.gameInfo.id/10) != 218561) {
    return false;
  }

  console.log("Football Manager 2022 Launched");
  return true;
...
function gameRunning(gameInfo) {
  ...
  // NOTE: we divide by 10 to get the game class id without it's sequence number
  if (Math.floor(gameInfo.id/10) != 218561) {
    return false;
  }

  console.log("Football Manager 2022 running");
  return true;
