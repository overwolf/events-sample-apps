...
function gameLaunched(gameInfoResult) {
  ...
  if (Math.floor(gameInfoResult.gameInfo.id/10) != 21620) {
    return false;
  }

  console.log("Legends of Runeterra Launched");
  return true;
...
function gameRunning(gameInfo) {
  ...
  // NOTE: we divide by 10 to get the game class id without it's sequence number
  if (Math.floor(gameInfo.id/10) != 21620) {
    return false;
  }

  console.log("Legends of Runeterra running");
  return true;
